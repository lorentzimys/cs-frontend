...
```js
const matrix3n4n5 = new Matrix(Int32Array, 3, 2, 2);

matrix3n4n5.set(0, 0, 0, 1); // 0*2**2 + 1*2**1 + 0*2**0 = 0
matrix3n4n5.set(0, 1, 0, 2); // 0*2**2 + 1*2**1 + 0*2**0 = 2
matrix3n4n5.set(0, 0, 1, 3); // 0*2**2 + 0*2**1 + 1*2**0 = 1
matrix3n4n5.set(0, 1, 1, 4); // 0*2**2 + 0*2**1 + 1*2**0 = 3
...
matrix3n4n5.set(2, 0, 0, 9);
matrix3n4n5.set(2, 1, 0, 10);
matrix3n4n5.set(2, 0, 1, 11);
matrix3n4n5.set(2, 1, 1, 12);
